...
<body>
    <div name="footer" class="cont-admin-bgcolor foot-flex foot-padding-top foot-padding-bot">
        <div class="foot-width">
            <img class="foot-img" src="/alumni/alum-images/aclcimg-tr.png" alt="ACLC COLLEGE">
        </div>
        <div class="foot-width menu-txtalign-left admin-txtcolor">
            <div><b>MISSION</b></div>        
            <p class="menu-txtalign-left">
        ...
        <div class="foot-width menu-txtalign-left admin-txtcolor">Footer</div>
    </div>
</body>
</html>